          ...
          <div className="space-y-6">
               ...
               <ul className="space-y-4">
                 ...
                 <li className="flex items-start gap-3">
                   ...
                   <div>
                     ...
                     <p className="text-sm text-slate-300">{new Date(event.date).toLocaleTimeString('fr-FR', { hour: '2-digit', minute: '2-digit' }).replace(':', 'h')} (Heure locale)</p>
                   </div>
                 </li>
               </ul>
            </div>
            ...
            <div className="rounded-2xl bg-slate-800/40 border border-slate-700/50 p-6">
               ...
               <div className="mt-8">
                  ...
                  <p className="text-center text-xs text-slate-500 mt-3">Paiement sécurisé. Billet envoyé par email.</p>
               </div>
            </div>
