            ...
            <div className="relative group rounded-3xl border border-slate-700/50 bg-slate-900/40 backdrop-blur-xl p-8 shadow-2xl transition-all duration-300 hover:border-slate-600/50 hover:shadow-indigo-500/10">
              ...
              <div className="relative z-10">
                ...
                <h1 className="mt-4 text-4xl font-extrabold tracking-tight text-white mb-3">
                  Re-bienvenue <span className="inline-block animate-[bounce_2s_infinite]">👋</span>
                </h1>

                <p className="text-base text-slate-300 leading-relaxed mb-6">
                  Connecte-toi pour gérer tes événements, consulter tes billets et accéder à ton dashboard avec une expérience fluide.
                </p>
                ...
                <div className="grid gap-3">
                  <div className="group/feature flex items-center space-x-4 rounded-2xl border border-slate-700/40 bg-slate-800/40 p-3 transition-all hover:bg-slate-800/60 hover:-translate-y-1">
                    ...
                    <div>
                      <div className="font-semibold text-white text-sm">Rapide</div>
                      <div className="text-xs text-slate-400">Accès instantané à tes événements.</div>
                    </div>
                  </div>
                  ...
                  <div className="group/feature flex items-center space-x-4 rounded-2xl border border-slate-700/40 bg-slate-800/40 p-3 transition-all hover:bg-slate-800/60 hover:-translate-y-1">
                    ...
                    <div>
                      <div className="font-semibold text-white text-sm">Sécurisé</div>
                      <div className="text-xs text-slate-400">Sessions et permissions gérées proprement.</div>
                    </div>
                  </div>
                </div>
              ...
              <div className="relative rounded-3xl border border-slate-700/50 bg-slate-900/60 backdrop-blur-xl p-6 sm:p-8 shadow-2xl">
                ...
                <div className="mt-6 relative">
                  ...
                  <div className="relative flex justify-center text-sm">
                    <span className="bg-slate-900 px-4 text-slate-400 rounded-full">Nouveau sur Rifle ?</span>
                  </div>
                </div>
